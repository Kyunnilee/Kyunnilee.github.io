    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-check-out-our-new-paper-generate-but-verify-reducing-visual-hallucination-in-vision-language-models-with-retrospective-resampling-https-reverse-vlm-github-io-link-to-x-reverse-vlm-https-x-com-tsunghan-wu-status-1913319463078019289",
          title: '🔥 Check out our new paper [Generate, but Verify: Reducing Visual Hallucination in...',
          description: "",
          section: "News",},{id: "projects-cheese-touch-a-temperature-dependent-simulation-of-melting-cheese",
